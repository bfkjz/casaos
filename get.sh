...
readonly CASA_UNINSTALL_URL="https://raw.githubusercontents.com/IceWhaleTech/get/main/uninstall.sh"
...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES=(
        "https://download.fastgit.org/IceWhaleTech/CasaOS-Gateway/releases/download/v0.3.6/linux-${TARGET_ARCH}-casaos-gateway-v0.3.6.tar.gz"
        "https://download.fastgit.org/IceWhaleTech/CasaOS-UserService/releases/download/v0.3.6/linux-${TARGET_ARCH}-casaos-user-service-v0.3.6.tar.gz"
        "https://download.fastgit.org/IceWhaleTech/CasaOS/releases/download/v0.3.6/linux-${TARGET_ARCH}-casaos-v0.3.6.tar.gz"
        "https://download.fastgit.org/IceWhaleTech/CasaOS-UI/releases/download/v0.3.6/linux-all-casaos-v0.3.6.tar.gz"
    )
}
